...
export default function Box({ title, description, img, link, date }) {
  ...
  return (
    <div className="flex flex-col rounded-md w-72 sm:w-80 hover:shadow-md transition-all duration-300 shadow-md space-y-4 justify-between items-center  bg-white  2xl:w-96 pb-3">
      <div className=" h-96">
        {src && (
          <Image
            alt="Failed to load"
